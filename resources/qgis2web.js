...
var map = new ol.Map({
    ...
    view: new ol.View({
         maxZoom: 28, minZoom: 1, projection: new ol.proj.Projection({
            code: 'EPSG:3857',
            extent: [-2115070.325072, 3123471.749105, 556597.453966, 5465442.183323],
            units: 'm'})
    })
});
...
map.getView().fit([-559878.626226, 4395745.451057, -546401.932714, 4406338.537293], map.getSize());
